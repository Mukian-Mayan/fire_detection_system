...
#define FIRE_ANALOG  A1           // Buzzer pin
...
int fireState = HIGH;    
int Firestate_analog = 0;  // Default (no fire)
...
void loop() {
  ...
  Firestate_analog = analogRead(FIRE_ANALOG);

  Serial.print("Smoke Value: ");
  Serial.print(smokeValue);
  Serial.print(" | Fire State analog: ");
  Serial.println(Firestate_analog);
  // Serial.print(" | Fire State d: ");
